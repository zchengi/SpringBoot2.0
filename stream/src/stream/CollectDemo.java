...
public class CollectDemo {
    public static void main(String[] args) {
        ...
        // 指定set 为 treeSet
        Set<Integer> agesTreeSet = students.stream().map(Student::getAge).collect(Collectors.toCollection(TreeSet::new));

        System.out.println("所有学生的年龄：" + ages);
        System.out.println("所有学生的年龄：" + agesSet);
